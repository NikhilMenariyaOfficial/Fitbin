<x-layouts.admin>
    <x-breadcrumb :title="''">
        ...
        <li class="breadcrumb-item active" aria-current="page">Unpaid Members</li>
    </x-breadcrumb>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
        <h2 class="h4">Unpaid Members List</h2>
    </div>
    ...
    <div class="table-settings mt-0 mb-4">
        <div class="row justify-content-between align-items-center">
            <div class="col-9 col-lg-8 d-md-flex">
                <div class="d-flex">
                    <form method="get" action="{{ route('alert.unpaid-members') }}"
            ...
            <div class="col-3 col-lg-4 d-flex justify-content-end">
                <div class="btn-group">
                    <x-table-limit-button :limit="$limit" route="alert.unpaid-members"></x-table-limit-button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow mt-4">
        <div class="card-header pt-3 pb-2 d-flex">
            ...
            <p class="m-0 bg-transparent"><b>Unpaid Members List</b></p>
        </div>
            ...
            <table class="table table-hover mt-2 bg-transparent">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="border-0">Membership Start</th>
                        ...
                        <tr>
                            ...
                            <td class="rounded-end">
                                <a href="{{ route('members.membership.payment', ['id' => $member->id]) }}"
                                    class="btn btn-sm btn-primary pe-3 ps-3 m-0">
