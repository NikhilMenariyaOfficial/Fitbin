<x-layouts.admin>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
        <div class="d-block mb-4 mb-md-0">
            <h2 class="h4">Personal Trainings</h2>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('personal-training.create') }}"
    ...
    <div class="table-settings mb-4"><div class="row justify-content-between align-items-center">
        <div class="col-9 col-lg-8 d-md-flex"><div class="d-flex">
                <form method="get" action="{{ route('personal-training.index') }}"
                ...
                @if ($search)
                    <a href="{{ route('personal-training.index') }}"
        ...
        <div class="col-3 col-lg-4 d-flex justify-content-end"><div class="btn-group">
            <x-table-limit-button :limit="$limit" route="personal-training.index"></x-table-limit-button>
        </div></div>
    </div></div>
    ...
    <div class="card border-0 shadow">
        <section class="card-header pt-2 pb-2">
            <strong>
                ...
                <span class="ms-2 text-primary">Personal Training List</span>
            </strong>
        </section>
                                    ...
                                    <div class="btn-group position-static">
                                        ...
                                        <div class="dropdown-menu py-0">
                                            <a class="dropdown-item rounded-top"
                                                href={{ route('personal-training.show', ['id' => $plan->id]) }}>
                                                <span class="fas fa-eye"></span>
                                                <span class="fw-bold">View Details</span>
                                            </a>
                                            <a class="dropdown-item"
                                                href={{ route('personal-training.edit', ['id' => $plan->id]) }}>
                                                <span class="fas fa-edit"></span>
                                                <span class="fw-bold">Edit</span>
                                            </a>
                                            <form
                                                action="{{ route('personal-training.destroy', ['id' => $plan->id]) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
